...
login_share="user"        # Логин для сетевого каталога
pass_share="pass"         # Пароль для сетевого каталога

# Для подключения второго сетевого каталога изменить переменные ниже и раскомментировать в основном блоке share2

share_ip2="192.168.122.95" # внутри кавычек меняем на актуальное
share_dir2="/тест тест"    # внутри кавычек меняем на актуальное
login_share2="user"        # внутри кавычек меняем на актуальное
pass_share2="pass"         # Полный путь/название каталога после ip адреса например "/тест тест/тест тест"
###############################################################################################
